	...
	<body>
		...
		<?php include 'php/name.html'; ?>
							...
							<p><a href="/buttons/sitemap.php" class="button big wide smooth-scroll-middle">Site Map</a></p>
                             
						<p>
							<a href="/buttons/index.php" class="button big wide smooth-scroll-middle" onclick="goBack()">Back</a>
                        </p>
<script>
function goBack() {
    window.history.back();
