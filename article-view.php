...
{               
?>
							<a href="/article-view.php?id=<?php echo htmlentities($result->id);?><?php echo $row['id'];?>" class="button big wide smooth-scroll-middle"><?php echo htmlentities($result->field2);?></a>
<?php }} ?>
